...
from main.views import show_main, create_product, show_product, show_json, show_xml, show_json_by_id, show_xml_by_id, delete_product, register, login_user, logout_user, edit_product, new_car, create_product_ajax, update_product_ajax, delete_product_ajax, login_ajax, register_ajax, logout_ajax, proxy_image, create_product_flutter
